...
import ru.kirilushkin.housemanaging.service.ApartmentService;
...
public class HouseManagingApplication {

	public static void main(String[] args) {
		ConfigurableApplicationContext context = SpringApplication.run(HouseManagingApplication.class, args);
